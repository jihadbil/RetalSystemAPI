...
public interface IStockApiService
{
    ...
    Task<ApiResponse<PagedResult<StorgeStockDto>>> GetPagedStorgeStocksByWarehouseAsync(Guid warehouseId, int pageNumber = 1, int pageSize = 10, string? searchTerm = null, CancellationToken ct = default);
    ...
    Task<ApiResponse<PagedResult<ShowroomStockDto>>> GetPagedShowroomStocksByWarehouseAsync(Guid warehouseId, int pageNumber = 1, int pageSize = 10, string? searchTerm = null, CancellationToken ct = default);
...
public class StockApiService : IStockApiService
{
    ...
    public Task<ApiResponse<PagedResult<StorgeStockDto>>> GetPagedStorgeStocksByWarehouseAsync(Guid warehouseId, int pageNumber = 1, int pageSize = 10, string? searchTerm = null, CancellationToken ct = default)
    {
    ...
    public Task<ApiResponse<PagedResult<ShowroomStockDto>>> GetPagedShowroomStocksByWarehouseAsync(Guid warehouseId, int pageNumber = 1, int pageSize = 10, string? searchTerm = null, CancellationToken ct = default)
    {
