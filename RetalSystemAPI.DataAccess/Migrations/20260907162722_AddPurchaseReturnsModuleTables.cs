...
{
    /// <inheritdoc />
    public partial class AddPurchaseReturnsModuleTables : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TotalAmount = table.Column<decimal>(type: "decimal(18,4)", precision: 18, scale: 4, nullable: false, defaultValue: 0m),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LineTotal = table.Column<decimal>(type: "decimal(18,4)", precision: 18, scale: 4, nullable: false, defaultValue: 0m),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PurchaseReturnItems_ProductBarCodes_ProductBarCodeId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PurchaseReturnItems_ProductBarCodeId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PurchaseReturnItems_TenantId_IsDeleted",
                table: "PurchaseReturnItems",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PurchaseReturns_TenantId_IsDeleted",
                table: "PurchaseReturns",
                columns: new[] { "TenantId", "IsDeleted" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PurchaseReturns_TenantId_WarehouseId",
                table: "PurchaseReturns",
