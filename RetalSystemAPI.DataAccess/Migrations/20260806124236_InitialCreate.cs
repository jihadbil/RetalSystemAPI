        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UnitPackage = table.Column<int>(type: "int", nullable: false, defaultValue: 1),
                    TenantId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BranchPhones_Tenants_TenantId",
                        column: x => x.TenantId,
                        principalTable: "Tenants",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProductUnits_Tenants_TenantId",
                        column: x => x.TenantId,
                        principalTable: "Tenants",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProductImages_ProductBarCodes_BarcodeId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BranchPhones_TenantId_PhoneNumber",
                table: "BranchPhones",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductImages_BarcodeId",
                table: "ProductImages",
                column: "BarcodeId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductUnits_ProductId_UnitId_TenantId",
                table: "ProductUnits",
                columns: new[] { "ProductId", "UnitId", "TenantId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_ProductUnits_TenantId",
                table: "ProductUnits",
                column: "TenantId");
